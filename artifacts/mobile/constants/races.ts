...
export const RACES: RaceDef[] = [
  ...
  },
  {
    ...
    resistances: { luz: 15, vento: 15, natureza: 10 },
    abilities: [
  ...
  },
  {
    ...
    resistances: { vento: 25, luz: 20, terra: -15 },
    abilities: [
  ...
  },
  {
    ...
    resistances: { vento: 30, trovao: 20 },
    abilities: [
  ...
  },
  {
    ...
    resistances: { escuridao: 15, vento: 15 },
    abilities: [
